...
export default {
  ...
  theme: {
  	...
  	extend: {
  		...
  		boxShadow: {
  			dental: '0 4px 20px -4px hsl(207 79% 51% / 0.12)',
  			'dental-elevated': '0 8px 30px -6px hsl(207 79% 51% / 0.18)',
  			header: '0 2px 20px 0 hsl(215 25% 15% / 0.08)',
  			'2xs': 'var(--shadow-2xs)',
  			xs: 'var(--shadow-xs)',
  			sm: 'var(--shadow-sm)',
  			md: 'var(--shadow-md)',
